...
local function loadEnemyData(filePath)
    ...
    enemyMap = {} -- Clear existing data

    local header = file:read("*l") -- Read the first line (header)
    local columns = {}
...
-- Example usage:
local enemyFilePath = "C:\\Users\\Admin\\Pictures\\aseprite\\lua testing\\smogoff rpg 2 - Enemies.csv"
loadEnemyData(enemyFilePath)

-- Example of reading the table:
for location, enemy in pairs(enemyMap) do
    print("Enemy at " .. location .. ": " .. enemy)
end
